...
export default function ClientLayout({ children }) {
    ...
    return (
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
            ...
            <div className={`flex flex-col h-screen overflow-hidden w-full pb-20 sm:pb-0 transition-all duration-300 ${isSidebarExpanded ? 'sm:ml-[68px] lg:ml-64 lg:w-[calc(100%-16rem)]' : 'sm:ml-[68px] sm:w-[calc(100%-68px)]'}`}>
                <Header 
