...
export default function ClientLayout({ children }) {
    ...
    return (
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
            ...
            <div className={`flex flex-col h-full flex-1 min-w-0 bg-background-default transition-all duration-300 ${isSidebarExpanded ? 'sm:ml-64 sm:w-[calc(100%-16rem)]' : 'sm:ml-[68px] sm:w-[calc(100%-68px)]'}`}>
