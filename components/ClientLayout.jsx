...
export default function ClientLayout({ children }) {
    ...
    return (
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
            ...
            <div className={`flex flex-col min-h-0 flex-1 overflow-hidden w-full pb-content-safe sm:pb-0 transition-all duration-300 ${isSidebarExpanded ? 'sm:ml-64 sm:w-[calc(100%-16rem)]' : 'sm:ml-[68px] sm:w-[calc(100%-68px)]'}`}>
                <Header
