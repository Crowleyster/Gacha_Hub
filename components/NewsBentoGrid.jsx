    ...
    return (
        <Link
            ...
            className={`
                ...
                ${news.isHero ? 'col-span-4 sm:col-span-8 md:col-span-8 h-64 md:h-96' : 'col-span-2 sm:col-span-4 md:col-span-4 h-48 md:h-auto'}
            `}
        >
            {/* Background Image */}
            <img 
            ...
            <div className="absolute inset-0 bg-linear-to-t from-background/90 via-background/40 to-transparent z-0" />
            ...
            <div className="flex flex-col justify-end p-4 relative z-10 h-full">
                ...
                <h3 className={`font-bold text-card-foreground leading-tight ${news.isHero ? 'text-lg md:text-2xl' : 'text-sm md:text-lg'}`}>
                    {news.title}
                </h3>
            </div>
        </Link>
