    ...
    return (
        <aside
            className={`
                ...
                hidden sm:flex p-2
                ${isExpanded ? 'sm:translate-x-0 w-64' : 'sm:translate-x-0 sm:w-16'}
            `}
        >
            {/* Header / Logo */}
            <div
                className={`flex items-center transition-opacity shrink-0 rounded-xl h-16 ${isExpanded ? 'px-4 gap-4 justify-start' : 'justify-center w-full'}`}
            >
            ...
            <nav
                className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 custom-scrollbar flex flex-col pt-2 pb-4 mt-1.5"
            >
                {TOP_NAV_ITEMS.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={`
                                flex items-center rounded-xl w-full shrink-0 h-14
