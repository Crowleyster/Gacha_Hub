        ...
        <SectionCarousel>
            {activeBanners.map(banner => (
                <button 
                    ...
                    className="relative w-[75vw] sm:w-[400px] aspect-[21/9] shrink-0 snap-center rounded-[24px] overflow-hidden border border-border-default-secondary bg-background-tertiary group/banner cursor-pointer text-left shadow-sm"
                >
                    {banner.imageUrl && (
